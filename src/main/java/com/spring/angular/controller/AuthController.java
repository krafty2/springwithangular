...
//			
//			java.util.Collection<?extends GrantedAuthority> autoritiesCollection = userDetails.getAuthorities();
//			
...
//    } 
	   ...
	   public ResponseEntity<Map<String,String>> requestForToken(	
	        ...
	        if(grandType.equals("password")){
	        	System.out.println(utilisateurService.searchByNom(username).get());
	            ...
	            Utilisateur appUser=utilisateurService.searchByNom(username1).get();
	        ...
	        return new ResponseEntity<Map<String, String>>(Map.of("error",String.format("grantType <<%s>> not supported ",grandType)),HttpStatus.UNAUTHORIZED);
	    }
